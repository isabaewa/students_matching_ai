...
def tokenize(text_or_list) -> set:
    """Токенизация: строку или список → множество слов (>=3 символов) в нижнем регистре."""
    ...
    def _run(self, students_json: str, supervisors_json: str) -> str:
        ...
        for student in students:
            ...
            for sup in supervisors:
                ...
                sup_keywords = tokenize(
                    sup.get("research_areas", []) + sup.get("keywords", [])
                )
                score = jaccard_similarity(s_interests, sup_keywords)
    ...
    def _build_matrix(self, students: list, supervisors: list) -> list:
        ...
        for s in students:
            ...
            for sup in supervisors:
                ...
                score = jaccard_similarity(s_tokens, sup_tokens)
